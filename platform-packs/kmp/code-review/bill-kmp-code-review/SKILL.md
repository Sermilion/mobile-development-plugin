...
Use when reviewing Kmp changes across code-review specialists.

## Specialist Scope

This skill reviews Kmp changes in one of two modes, chosen at runtime based on the pack's `declared_code_review_areas` in `platform.yaml`:
...
- **No specialists declared** — review Kmp directly here. Cover architecture, correctness, security, performance, and testing concerns in one pass.
