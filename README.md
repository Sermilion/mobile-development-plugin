...
- **`SKILL.md`** — generated governance shell. Carries frontmatter
  ...
  the required H2 set, and a byte-identical `## Execution` body linking to
  the sibling. Authors do not edit this file directly.
- **`content.md`** — user-owned, free-form skill body. No required H2s,
  no frontmatter requirement, no minimum length. Open it with
